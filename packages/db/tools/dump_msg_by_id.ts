 ...
 *
 * Run:  pnpm tsx ./packages/db/tools/dump_msg_by_id.ts <msgId> [<msgId> ...]
 *   or  WEQ_TEST_MSG_IDS="7651461878938216377,7661671524070269822" pnpm tsx ./packages/db/tools/dump_msg_by_id.ts
 *
...
async function main(): Promise<void> {
  ...
  if (ids.length === 0) {
    console.error('usage: pnpm tsx ./packages/db/tools/dump_msg_by_id.ts <msgId> [<msgId> ...]');
    process.exit(1);
  }
