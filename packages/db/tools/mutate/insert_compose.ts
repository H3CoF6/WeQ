 ...
 *
 * ⚠️ WRITES to the live DB. Back up first. Run: pnpm tsx ./packages/db/tools/mutate/insert_compose.ts
 */
...
async function main(): Promise<void> {
  requireMutationConsent('走 compose→encode→append 链路往 group_msg_table 插入消息');
