...
import type { BuiltGraph, GEdge, GNode, GraphSettings, RawNode, RelationGraphData } from './types';
...
export function buildGraph(
  ...
  return settings.mode === 'groups' ? buildGroups(data, settings) : buildPeople(data, settings);
}
