...
export function BuddyAnalyticsDialog({
  ...
  const [data, setData] = useState<BuddyAnalyticsData | null>(
    (initialData as BuddyAnalyticsData) ?? null,
  );
  ...
  const card = (
    ...
    >
      ...
      <div className="group-album-body ba-body">
        {loading ? (
          <AnalyticsSkeleton variant="buddy" />
        ) : error ? (
