    ...
    <aside className={cn('app-rail', hideAvatar && 'hide-avatar')} ref={railRef}>
      ...
      <div className={cn('rail-groups')}>
        <nav className={cn('rail-nav rail-nav-primary')} aria-label="Primary">
          <button
            className={cn(railButtonClass(activeView === 'messages'), 'rail-tab rail-tab-messages')}
          ...
          >
            ...
            {messageBadgeCount > 0 ? (
              <span className={cn('rail-badge')}>{formatBadgeCount(messageBadgeCount)}</span>
            ) : null}
          </button>
          <button
            className={cn(railButtonClass(activeView === 'contacts'), 'rail-tab rail-tab-contacts')}
          ...
          >
            ...
            {contactBadgeCount > 0 ? (
              <span className={cn('rail-badge')}>{formatBadgeCount(contactBadgeCount)}</span>
            ) : null}
          </button>
          <button
            className={cn(railButtonClass(activeView === 'qzone'), 'rail-tab rail-tab-qzone')}
          ...
          <button
            className={cn(railButtonClass(activeView === 'channel'), 'rail-tab rail-tab-channel')}
          ...
          <button
            className={cn(railButtonClass(activeView === 'export'), 'rail-tab rail-tab-export')}
          ...
          <button
            className={cn(railButtonClass(activeView === 'agentlab'), 'rail-tab rail-tab-agentlab')}
          ...
          <button
            className={cn(railButtonClass(activeView === 'cache'), 'rail-tab rail-tab-cache')}
          ...
          <button
            className={cn(railButtonClass(activeView === 'annual'), 'rail-tab rail-tab-annual')}
          ...
          <div className={cn('rail-more-wrap')} ref={moreRef}>
            <button
              className={cn(menuOpen && 'active', 'rail-tab rail-tab-more')}
              onClick={() => {
                setProfileOpen(false);
...
function ContactRailIcon() {
  return (
    <svg className="rail-contact-icon" viewBox="0 0 28 28" aria-hidden="true">
      ...
      <path className="rail-contact-body-fill" d="M4.5 24.5a9.5 7.5 0 0 1 19 0H4.5Z" />
      <path className="rail-contact-collar" d="M11.2 17.5h5.6L14 21Z" />
      <path className="rail-contact-body-line" d="M4.5 24.5a9.5 7.5 0 0 1 19 0" />
    </svg>
  );
}
  ...
  return (
    <section className={cn('profile-popover')}>
      <div className={cn('profile-popover-head')}>
        <Avatar name={displayUserName(user)} avatarUrl={user.avatarUrl} seed={user.identityValue} />
        <div>
