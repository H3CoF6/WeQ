...
export function composeComposerActionRegistry({
  ...
  return {
    ...
    plusPanel: [...(prepend.plusPanel ?? []), ...base.plusPanel, ...(append.plusPanel ?? [])],
  };
}
...
export function resolveComposerActionRegistry(
  ...
  return {
    desktopToolbar: registry?.desktopToolbar ?? defaultComposerActionRegistry.desktopToolbar,
    mobileToolbar: registry?.mobileToolbar ?? defaultComposerActionRegistry.mobileToolbar,
    mobileExpandedToolbar:
      registry?.mobileExpandedToolbar ?? defaultComposerActionRegistry.mobileExpandedToolbar,
