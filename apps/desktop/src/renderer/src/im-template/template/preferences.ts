...
export const conversationPreferenceKey = 'chat-template:conversation-preferences';
...
export function saveConversationPreferences(preferences: ConversationPreferences) {
  window.localStorage.setItem(conversationPreferenceKey, JSON.stringify(preferences));
}
