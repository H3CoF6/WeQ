...
export type ConversationDetailAction = {
  ...
  value?: string | ((context: ConversationDetailActionContext) => string | undefined);
  icon?: LucideIcon;
...
export function resolveConversationDetailActionRegistry(
  ...
  return {
    directDesktop: registry?.directDesktop ?? defaultConversationDetailActionRegistry.directDesktop,
    groupDesktop: registry?.groupDesktop ?? defaultConversationDetailActionRegistry.groupDesktop,
    directMobile: registry?.directMobile ?? defaultConversationDetailActionRegistry.directMobile,
    groupMobile: registry?.groupMobile ?? defaultConversationDetailActionRegistry.groupMobile,
  };
}
...
export function conversationDetailActionValue(
  ...
  return typeof action.value === 'function' ? action.value(context) : action.value;
}
