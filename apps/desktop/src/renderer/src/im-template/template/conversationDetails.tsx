...
export function ConversationDetailsPanel({
  ...
  return (
    <aside className={cn('conversation-details')} ref={panelRef} aria-label="会话设置">
      <div className={cn('conversation-details-profile')}>
        ...
        <span className={cn('copyable-text')}>
          {conversation.otherUser.identityLabel} {conversation.otherUser.identityValue}
        </span>
      </div>

      <DesktopDetailActionGroups groups={actionRegistry.directDesktop} context={actionContext} />
    </aside>
  );
}
