  ...
  return (
    <div className="weq-profile-layer" role="presentation" onMouseDown={onClose}>
      ...
      >
        ...
        <div className={cn('weq-notice-scroll', requests.length === 0 && 'is-empty')}>
          {requests.length === 0 ? (
            <EmptyState
              title="暂无好友通知"
            ...
            requests.map((request) => {
              ...
              return (
                ...
                >
                  ...
                  <div className={cn('notice-copy')}>
                    ...
                    {request.operator ? (
                      <span className="notice-operator">
                        ...
                        {request.respondedAt ? ` · ${formatProfileDate(request.respondedAt)}` : ''}
                      </span>
                    ) : null}
                  ...
                  {request.isDoubt ? <div className={cn('notice-doubt-mark')} /> : null}
                </article>
              );
            })
          )}
